...
Сравнение картинок — по цвету (RGB 16x16, средняя разница каналов): Shopify
пережимает файлы, побайтово не сходится, а серый dHash не отличает синюю пробку
от красной (проверено: одинаковые дают 0.0-0.1, разные цвета — от 6).
...
SAME = 2.0            # порог «та же картинка» по средней разнице RGB
